...
# Constants
FILE_SEP = '\t'
HEADER_START = 'Start genomic coordinate'
HEADER_STOP = 'End genomic coordinate'
HEADER_PROT_SEQ = 'Protein sequence'


def Samandi2017( data_path ):
    ...
    for ( index, row ) in csv_content.iterrows():
        ...
        orf_len = len( row[ HEADER_PROT_SEQ ] )
        orf_len_nt = int( orf_len ) * 3 + 2
