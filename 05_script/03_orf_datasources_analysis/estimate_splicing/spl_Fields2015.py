...
# Constants
FILE_SEP = ','
HEADER_START = 'Start codon coordinate'
HEADER_STOP = 'Stop codon coordinate'
HEADER_ORF_LEN = 'Protein length (AA)'


def Fields2015( data_path ):
    ...
    for ( index, row ) in csv_content.iterrows():
        ...
        orf_len_nt = int( float( orf_len ) ) * 3 + 3
